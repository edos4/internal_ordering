class BotController < ApplicationController
  ...
  def self.send_chatfuel_msg(messenger_id, block_name, params)
    ...
    RestClient::Request.new({
      method: :post,
      url: "https://api.chatfuel.com/bots/#{ENV['chatfuel_key']}/users/#{messenger_id}/send?chatfuel_token=mELtlMAHYqR0BvgEiMq8zVek3uYUK3OJMbtyrdNPTrQB9ndV0fM7lWTFZbM4MZvD&chatfuel_message_tag=CONFIRMED_EVENT_REMINDER&chatfuel_block_name=#{block_name}&#{params}",
      headers: { 
        accept: :json, 
        content_type: :json
      }
