...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { image: @variant.image, name: @variant.name, price: @variant.price, product_id: @variant.product_id } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { image: @variant.image, name: @variant.name, price: @variant.price, product_id: @variant.product_id } }
