...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { category_id: @merchant.category_id, logo: @merchant.logo, name: @merchant.name } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { category_id: @merchant.category_id, logo: @merchant.logo, name: @merchant.name } }
